...
* Hosts - список или сет всех возможных вариантов http-заголовка Host, с которыми должен ассоциироваться этот модуль. (если содержит строку "any", ассоциировается со всеми)  
...
```python  
def apply_json_scheme(obj,scheme)  
```  
